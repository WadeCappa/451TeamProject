    ...
    with open('.//yelp_user.JSON','r') as f:  
        ...
        while line:
            ...
            outfile.write("{} - user info : '{}' ; '{}' ; '{}' ;\n    friend info : {}  ;\n".format(
                              str(count_line), # the line count
                              cleanStr4SQL(str(data['average_stars'])),
                              cleanStr4SQL(str(data["cool"])),
                              cleanStr4SQL(str(data["fans"])),
                              #cleanStr4SQL(data["friends"])))
                              cleanStr4SQL(getFriendsString(data["friends"]))))
